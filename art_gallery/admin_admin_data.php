...
<body style="background: #f9f9f9">
    <header class="all_header admin_header">
        ...
        <div class="adm_slide bg-secondary">
            ...
            <a href="#"><button class="wel_btn adm_btn adm_active" id="adm_adm_da ">Admin Database</button></a>
            <a href="adm_Image_data.php"><button class="wel_btn adm_btn" id="adm_img_da">Images Database</button> </a>
        </div>
        <div class="Welcome_text">
            <h3>Admin Database Records</h3>
        </div>

        <a href="add_admin.php"><button type="button" class="btn btn-primary"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                ...
                                                <a href="delete.php?deleteAdmID=' . $id . '">
