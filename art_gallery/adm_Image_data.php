...
<body style="background: #f9f9f9">
    <header class="all_header admin_header">
        ...
        <div class="adm_slide bg-secondary">
            ...
            <a href="adm_artist_data.php"><button class="wel_btn adm_btn" id="adm_art_da">Artist Database</button></a>
            <a href="admin_admin_data.php"><button class="wel_btn adm_btn " id="adm_adm_da ">Admin Database</button></a>
            <a href="#"><button class="wel_btn adm_btn adm_active" id="adm_img_da">Images Database</button> </a>
        </div>
        <div class="Welcome_text">
            <h3>Images Database Records</h3>
        </div>

        <a href="add_image.php"><button type="button" class="btn btn-primary"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    ...
                                                    <a href="delete.php?deleteImgID=' . $id . '">
